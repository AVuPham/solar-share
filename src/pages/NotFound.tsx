...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-sky-50 to-white px-6 text-center">
      ...
      <p className="mt-4 text-xl text-gray-700">Oops! Trang bạn tìm không tồn tại.</p>
      <p className="mt-2 text-gray-500">Có thể đường dẫn đã bị thay đổi hoặc bạn nhập sai URL.</p>
      <Link
        to="/"
